...

{
	...
	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 404192, dp + 398104, 0, 15, 0, 15, 16, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 404232, dp + 398216, 0, 7, 0, 7, 8, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 404384, dp + 398328, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 404328, dp + 398552, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 406312, dp + 407024, 0, 10, 0, 10, 11, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 406352, dp + 406968, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 473584, dp + 399224, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 473704, dp + 475200, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 473760, dp + 475256, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 473816, dp + 475424, 0, 15, 0, 15, 16, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 473856, dp + 475536, 0, 7, 0, 7, 8, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 473896, dp + 475480, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 473936, dp + 475312, 0, 0, 0, 0, 1, 1);

}

void simulate(char *dp)
{
iki_register_root_pointers(7, 60720, 38,0,59208, 32,1, 1,111200, 46,0,116192, -5,0,124776, -7,0,130328, 21,0,130496, 20,0) ; 
...
int main(int argc, char **argv)
{
    ...
    iki_svlog_initialize_virtual_tables(17, 36, ng360, 35, ng350, 14, ng140, 24, ng240, 23, ng230, 34, ng340, 22, ng220, 33, ng330, 31, ng310, 39, ng390, 13, ng130, 12, ng120, 20, ng200, 30, ng300, 21, ng210, 38, ng380, 29, ng290);
