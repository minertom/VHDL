...
HD_PWD='D:/Dropbox/Git/VHDL/I2S/I2S_Audio.runs/ClockGeneration_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ClockGeneration_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ClockGeneration_clk_wiz_0_0.tcl
